        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-start">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <a href="tel:+905356158454" className="flex items-center gap-4 bg-gray-800/50 p-4 rounded-xl border border-gray-700 hover:border-orange-500 hover:bg-gray-800 transition-all group">
              ...
              <a href="https://wa.me/905356158454" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 bg-gray-800/50 p-4 rounded-xl border border-gray-700 hover:border-green-500 hover:bg-gray-800 transition-all group">
